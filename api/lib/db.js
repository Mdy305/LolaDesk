...
export async function updateTenantFields(tenantId, patch = {}){
  ...
  const allowed = ['name','owner_name','location','hours','booking_url','website_url','business_mode','persona','services','team','phone_number','operator_phone','autopilot_enabled'];
  const row = {};
