...
-- 20260829_backfill_booking_baseline.sql — per-tenant booking basics for
-- tenants that predate the provisioning seed (schedules/services/staff/settings).
...
/* vim: set noet ts=4 sw=4: -- appended 20260831_mfa_totp.sql */
...
-- 20260831_email_verify.sql appended
...
-- 20260901_force_tenant_activation_status.sql appended
