...
(function(){
  ...
  +   'background:radial-gradient(circle at 32% 30%,#ff8fc0,#ff2d8e 55%,#7a1050);box-shadow:0 8px 30px rgba(255,45,142,.45);'
  ...
  + '@keyframes breathe{0%,100%{box-shadow:0 8px 30px rgba(255,45,142,.45)}50%{box-shadow:0 8px 44px rgba(255,45,142,.7)}}'
  ...
  + '.dot{width:34px;height:34px;border-radius:50%;background:radial-gradient(circle at 32% 30%,#ff8fc0,#ff2d8e 60%,#7a1050);flex:none}'
  ...
  + '.typing{display:inline-flex;gap:4px;padding:12px 14px}.typing i{width:6px;height:6px;border-radius:50%;background:#ff7fb8;animation:blink 1.1s infinite}'
